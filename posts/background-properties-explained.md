---
title: The Fastest Way to Set CSS Backgrounds
shortDescription: Replace 8 properties and 8 lines of CSS with just 1
category: CSS
...
You can also use one of the [140 predefined colors](https://htmlcolorcodes.com/color-names/), or the `transparent` keyword.
...
But why can’t we just write the URL without some fancy *function*? Because there are other image sources in CSS. For example: [gradients](https://hadrysmateusz.medium.com/complete-guide-to-css-gradients-f6212760a268).

```css
background-image: linear-gradient(red,yellow);
```

Yeah, gradients are images in CSS. If you find this hard to remember like me, use the [background shorthand](https://hadrysmateusz.medium.com/the-fastest-way-to-set-css-backgrounds-47e7e5e17bab). It does the remembering for you 😄
...
- `text` - The background will only be visible under the element's text content. Make sure to set `color: transparent` to see the background. This can be used to achieve some cool effects like [gradient text](https://hadrysmateusz.medium.com/gradient-text-in-css-609068d3f953).
...
This problem can be prevented by using the [background shorthand](https://hadrysmateusz.medium.com/the-fastest-way-to-set-css-backgrounds-47e7e5e17bab).
